package com.github.kawevk.libraryapi.config;
...
//    Não é eficiente usar o DriverManagerDataSource em produção, pois ele cria uma nova conexão a cada requisição.
//    @Bean
